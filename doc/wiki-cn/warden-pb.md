...
`internal/service`内的`Service`结构实现了`DemoServer`接口可参考[kratos-demo内的service](https://git.huoys.com/middle-end/kratos-demo/blob/master/internal/service/service.go)内的如下代码：
