...
func create() (err error) {
	...
	if p.onlyHTTP {
		...
		box = packr.New("game", "./templates/game")
	} else if p.businessService {
		box = packr.New("business", "./templates/servicebus")
		p.ModPrefix = "git.huoys.com/middle-business/"
	}
